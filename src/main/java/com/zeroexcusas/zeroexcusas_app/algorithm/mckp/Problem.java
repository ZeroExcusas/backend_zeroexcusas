...
import com.zeroexcusas.zeroexcusas_app.algorithm.mckp.IProblem;
...
public abstract class Problem implements IProblem {
    ...
    Problem() {
        ...
        System.out.println("profit: "+this.profit.length);

        System.out.println("weight: "+this.weight.length);
